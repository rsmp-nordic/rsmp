module RSMP
  ...
  class Filter
    ...
    def accept?(message)
      ...
      return false if @type && !message.is_a?(MessageNotAck) && !@type.include?(message.type)
      return false if @component && message.attributes['cId'] && message.attributes['cId'] != @component
