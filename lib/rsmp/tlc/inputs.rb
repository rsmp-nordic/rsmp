module RSMP
  module TLC
    ...
    class Inputs
      ...
      def force(input, forced_value = nil, **options)
        value = if options.key?(:forced_value)
                  options[:forced_value]
                elsif forced_value.nil?
                  true
                else
                  forced_value
                end
        ...
        report_change(input) do
          set_forcing input, force: true, forced_value: value
        end
      end
