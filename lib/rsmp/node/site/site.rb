...
module RSMP
  class Site < Node
    ...
    def handle_site_settings(options = {})
      ...
      defaults['components']['main'] = site_settings['components']['main'] if main_component_override?(site_settings)

      @site_settings = defaults.deep_merge site_settings
    ...
    def main_component_override?(site_settings)
      site_settings.dig('components', 'main')
    end
