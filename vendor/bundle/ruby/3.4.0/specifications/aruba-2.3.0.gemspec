...
Gem::Specification.new do |s|
  ...
  s.summary = "aruba-2.3.0".freeze

  s.installed_by_version = "3.6.9".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<bundler>.freeze, [">= 1.17".freeze, "< 3.0".freeze])
  s.add_runtime_dependency(%q<contracts>.freeze, [">= 0.16.0".freeze, "< 0.18.0".freeze])
  s.add_runtime_dependency(%q<cucumber>.freeze, [">= 8.0".freeze, "< 10.0".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.4".freeze])
  ...
  s.add_development_dependency(%q<kramdown>.freeze, ["~> 2.1".freeze])
  s.add_development_dependency(%q<minitest>.freeze, ["~> 5.10".freeze])
  s.add_development_dependency(%q<rake>.freeze, [">= 12.0".freeze, "< 14.0".freeze])
  ...
  s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.21".freeze])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 3.0".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, [">= 0.18.0".freeze, "< 0.23.0".freeze])
end
