# -*- encoding: utf-8 -*-
# stub: cucumber-html-formatter 21.9.0 ruby lib

Gem::Specification.new do |s|
  s.name = "cucumber-html-formatter".freeze
  s.version = "21.9.0".freeze
  ...
  s.summary = "cucumber-html-formatter-21.9.0".freeze

  s.installed_by_version = "3.6.9".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 19".freeze, "< 28".freeze])
