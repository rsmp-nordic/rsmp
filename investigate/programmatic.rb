...
farm = Node.new(id: :farm2, supervisor: app, worker_class: Place, strategy: :rest_for_one)
...
house = Node.new(id: :house3, supervisor: app, worker_class: Place, strategy: :one_for_one)
